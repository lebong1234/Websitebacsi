              ...
              {isSignIn && (
                <div className="space-y-4">
                  ...
                  <div className="flex justify-center space-x-4">
                    ...
                    {/* Nút Google Login */}
                    {isGoogleLoading ? (
                      <button disabled className="p-3 rounded-lg bg-red-100 text-red-600 flex items-center justify-center w-[44px] h-[44px]"> {/* Kích thước cố định cho spinner */}
                      ...
                      <GoogleLogin
                        ...
                        shape="circle" // 'rectangular', 'circle', 'pill'
                        theme="outline" // 'outline', 'filled_blue', 'filled_black'
                        size="medium" // 'small', 'medium', 'large'
                        logo_alignment="left" // 'left', 'center'
                        // width="240px" // Bỏ width để nó tự điều chỉnh theo type='icon' và size
                        // useOneTap // Cân nhắc sử dụng One Tap UI nếu muốn
                        disabled={isLoading} // Vô hiệu hóa khi đăng nhập thường đang xử lý
                      />
                    )}

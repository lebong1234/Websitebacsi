...
// Tạo lịch và lấy link thanh toán PayOS
export async function createAppointmentAndGetPaymentLink(appointment) {
    try {
        const response = await axios.post(
            'http://localhost:2000/api/booking/create-and-get-payment-link',
            appointment
        );
        return response.data;
    } catch (error) {
        console.error('Lỗi khi tạo lịch và lấy link thanh toán:', error);

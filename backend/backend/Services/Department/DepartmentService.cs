...
namespace backend.Services
{
    public class DepartmentService : IDepartmentService
    {
        ...
        {
            if (string.IsNullOrEmpty(id) || id == "all" || !ObjectId.TryParse(id, out _))
                return null;
        ...
        {
            if (string.IsNullOrEmpty(departmentId) || departmentId == "all" || !ObjectId.TryParse(departmentId, out _))

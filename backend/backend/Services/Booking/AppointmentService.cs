...
namespace backend.Services
{
    public interface IAppointmentService
    {
        ...
        Task<List<ConfirmAppointment>> GetByUserIdAsync(string userId);
    }
    ...
    public class AppointmentService : IAppointmentService
    {
        ...
        public async Task<List<ConfirmAppointment>> GetByUserIdAsync(string userId)
        {
            return await _appointments.Find(a => a.PatientId == userId).ToListAsync();
        }
    }
}
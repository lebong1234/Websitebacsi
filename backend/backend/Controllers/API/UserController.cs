...
namespace backend.Controllers.API
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [HttpGet("{id}/bookings")]
        public Task<IActionResult> GetUserBookings(string id)
        {
            ...
            return Task.FromResult<IActionResult>(Ok(bookings));
        }

        [HttpGet("{id}/packages")]
        public Task<IActionResult> GetUserPackages(string id)
        {
            ...
            return Task.FromResult<IActionResult>(Ok(packages));
        }
    }
} 
...
namespace backend.Controllers
{
    ...
    public class DoctorController : ControllerBase
    {
        ...
        [HttpGet("filter")]
        public async Task<IActionResult> FilterDoctors([FromQuery] string? departmentId, [FromQuery] string? specialtyId, [FromQuery] string? branchId)
        {
            var doctors = await _doctorService.FilterDoctorsWithDetailsAsync(departmentId, specialtyId, branchId);
            return Ok(doctors);
        }

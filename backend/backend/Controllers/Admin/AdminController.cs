...
namespace backend.Controllers.Admin
{
    ...
    public class AdminController : Controller
    {
        ...
        public AdminController(IUserService userService, IDepartmentService departmentService, IBranchService branchService, IPackageService packageService, IDoctorService doctorService)
        {
